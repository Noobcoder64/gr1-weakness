...
class parallel_policy(object):
    ...
    def __init__(self, nthreads: "unsigned int"=1):
...
class acc_cond(object):
    ...
    apply_permutation_aux = _swig_new_instance_method(_impl.acc_cond_apply_permutation_aux)
...
twa_prop_set_all = _impl.twa_prop_set_all
...
class state_product(state):
    ...
    def __init__(self, left: "state", right: "state", pool: "fixed_size_pool< pool_type::Safe > *"):
...
aig_aig_true = _impl.aig_aig_true
aig_aig_false = _impl.aig_aig_false
aig_parse_aag = _impl.aig_parse_aag
...
class hoa_alias_formater(object):
    ...
    def __init__(self, aut: "spot::const_twa_graph_ptr const &", false_str: "char const *", true_str: "char const *", or_str: "char const *", and_str: "char const *", not_str: "char const *", lpar_str: "char const *", rpar_str: "char const *", ap_printer: "std::function< std::string (int) >"):
